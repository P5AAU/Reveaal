...
mod test {
    ...
    #[test]
    fn t1_refines_self() {
        assert!(refinement_check(PATH, "refinement: Test1 <= Test1"));
    }

    #[test]
    fn t2_refines_self() {
        assert!(refinement_check(PATH, "refinement: Test2 <= Test2"));
    }

    #[test]
    fn t3_refines_self() {
        assert!(refinement_check(PATH, "refinement: Test3 <= Test3"));
    }

    #[test]
    fn t4_refines_self() {
        assert!(refinement_check(PATH, "refinement: Test4 <= Test4"));
    }

    #[test]
    fn t5_refines_self() {
        assert!(refinement_check(PATH, "refinement: Test5 <= Test5"));
    }
